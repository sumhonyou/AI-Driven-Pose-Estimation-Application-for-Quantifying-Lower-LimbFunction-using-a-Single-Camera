...
const en = {
  ...
  landing: {
    ...
    fLink4: "Dashboard",
    fLink5: "About",
    fLink6: "Feedback survey",
    fLink8: "Contact",
    copyright: "© 2026 PhysioFit · Non-diagnostic movement-quality tool.",
    madeFor: "Made for general public use.",
    feedbackTitle: "What should PhysioFit do next?",
    feedbackLead:
      "This is a Final Year Project prototype. A short survey tells us which features matter most to you.",
    feedbackCta: "Open the survey",
  },
  contact: {
    title: "Project contact",
    intro:
      "PhysioFit is an academic Final Year Project prototype at Sunway University. For questions about the project, reach out below.",
    studentLabel: "Student",
    studentRole: "Final Year Student, BSc (Hons) Computer Science Programme",
    supervisorLabel: "Supervisor",
    supervisorRole: "Lecturer",
    close: "Close",
  },
  auth: {
  ...
  progress: {
    ...
    slsHoldTrendSub: "Longest balance hold each session, left vs right",
    wbltDistanceTrend: "Best reach per leg",
    wbltDistanceTrendSub: "Furthest reach distance each session, left vs right",
    metricCompletionTime: "Completion time",
    metricAvgRepTime: "Avg. rep time",
    axisDate: "Date",
    axisSeconds: "Seconds",
    axisCentimetres: "Centimetres",
    axisScore: "Score",
    bothLegs: "Both legs",
