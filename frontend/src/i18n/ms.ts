...
const ms: Dict = {
  ...
  progress: {
    ...
    captureQualityTrend: "Aliran kualiti tangkapan",
    captureQualityTrendSub: "Adakah kedudukan kamera bertambah baik selepas digesa?",
    repVolumeTrend: "Jumlah ulangan",
    repVolumeTrendSub: "Percubaan berbanding ulangan yang dikira setiap sesi",
    repsCounted: "Dikira",
