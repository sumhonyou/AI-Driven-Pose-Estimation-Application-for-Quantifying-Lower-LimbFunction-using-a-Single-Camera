...
const ms: Dict = {
  ...
  progress: {
    ...
    confidenceTrend: "Aliran keyakinan",
    confidenceTrendSub: "Keyakinan model dari semasa ke semasa",
  ...
  report: {
    ...
    trendScoreChanged: "markah {{sign}}{{value}}/10",
    trendTimeChanged: "masa {{sign}}{{value}}s",
    trendHoldChanged: "tahanan {{sign}}{{value}}s",
    trendRepsChanged: "ulangan {{sign}}{{value}}",
