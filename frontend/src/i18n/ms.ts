...
const ms: Dict = {
  ...
  landing: {
    ...
    fLink4: "Papan pemuka",
    fLink5: "Tentang",
    fLink6: "Soal selidik maklum balas",
    fLink8: "Hubungi",
    copyright: "© 2026 PhysioFit · Alat kualiti pergerakan bukan diagnostik.",
    madeFor: "Direka untuk kegunaan orang awam.",
    feedbackTitle: "Apa yang patut ada dalam PhysioFit seterusnya?",
    feedbackLead:
      "Ini ialah prototaip Projek Tahun Akhir. Soal selidik ringkas memberitahu kami ciri yang paling penting bagi anda.",
    feedbackCta: "Buka soal selidik",
  },
  contact: {
    title: "Hubungan projek",
    intro:
      "PhysioFit ialah prototaip Projek Tahun Akhir akademik di Sunway University. Untuk pertanyaan tentang projek ini, hubungi kami di bawah.",
    studentLabel: "Pelajar",
    studentRole: "Pelajar Tahun Akhir, Program BSc (Kepujian) Sains Komputer",
    supervisorLabel: "Penyelia",
    supervisorRole: "Pensyarah",
    close: "Tutup",
  },
  auth: {
