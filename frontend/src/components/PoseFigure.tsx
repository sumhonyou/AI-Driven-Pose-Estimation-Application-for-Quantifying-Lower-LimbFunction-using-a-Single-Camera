...
export default function PoseFigure() {
  return (
    <svg className="pose" viewBox="0 0 300 260" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
      <g>
      ...
      <g>
        {[[150,40,9],[150,70,4.5],[112,104,4.5],[188,104,4.5],[100,150,4.5],[200,150,4.5],[150,120,5.5],[124,170,6.5],[176,170,6.5],[116,224,5],[184,224,5]].map((c, i) => (
