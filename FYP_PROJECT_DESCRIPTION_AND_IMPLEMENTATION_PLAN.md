...
| Lunge frontend placeholder                            | §10 gated all lunge work behind Phase 5B, with no frontend artifact before then                                                        | Ahead of Phase 5B, the exercise catalog already seeds a `lunge` row and `ExerciseSelection.tsx`/`CameraSetup.tsx` already show its real thumbnail and tutorial video; **only** the Start Session button is disabled (replaced with a "coming soon" message) since no backend plugin, live page, or analyze wiring exists yet                                                                                                                                                                                                                                  | HY supplied both exercises' real thumbnail/video assets together in Phase 4 Stage 4.7 and asked for the lunge card to read as "coming soon" rather than being hidden entirely; no Module B logic was pulled forward — see task.md Phase 4 Stage 4.7 and the Phase 5B gate note                                                                                                         |
| ⚠️ Module B exercise scope (supersedes the row above) | Decided 2026-07-15: squat first, then lunge (Phase 5B) as a second committed Module B exercise                                         | **Reversed 2026-07-19 (HY's decision): Leg Lunge removed from the product entirely.** Squat is the only Module B rehab-grading exercise. All lunge backend/frontend/ML code deleted; the exercise catalog no longer offers it; every row above and below that mentions "lunge" describes work that was completed and then withdrawn, not the current system                                                                                                                                                                                                   | Product decision, not further elaborated in this document — see task.md's Phase 5B section for the retained historical record of the investigation                                                                                                                                                                                                                                     |
