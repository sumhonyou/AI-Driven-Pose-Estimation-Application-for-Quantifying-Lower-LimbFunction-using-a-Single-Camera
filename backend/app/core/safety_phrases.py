...
nor any backend-generated text (Stage 6.3's LLM safety filter) may state a clinical
conclusion (e.g. "your balance is normal") or a diagnosis. Allowed: band statements like
"your holding time was in the Good/Fair/Poor band" and negated statements like "not a
medical diagnosis" — only affirmative clinical claims are forbidden.
...
(which scans LLM-generated text before it is stored or shown) — **one list, shared**, per
task.md Stage 6.3's instruction not to fork it.
"""
